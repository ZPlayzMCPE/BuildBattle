...
class BB extends PluginBase implements Listener {
	...
	{
		$this->getLogger()->notice(TE::AQUA . "BuildBattle by Crack Pixel And Pyxel Ruby");
		...
		foreach($this->arenas as $lev)
		{
			$this->getServer()->loadLevel($lev);
                ...
                $theme = array("Human - Bird","Pez - Fish","Auto - Car","Dragón","Internet","Noob - Frog","Mario Bros","Money - Dog","Pro - Frog","Tractor","Killer - Boat","WaterFall","Tiger - Candy","Pixel - AirPlane","Superhéro","Football- Soccer","MCPE Mobs-Monsters");
